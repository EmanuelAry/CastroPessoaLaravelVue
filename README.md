# Projeto Laravel com Pacote de Autenticação Laravel/UI e Vue

Este projeto já está com a autenticação por login e redefinição de senha configurados.
...
```
git clone https://github.com/EmanuelAry/CastroPessoaLaravelVue
```
